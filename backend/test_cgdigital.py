...
def investigate_cgdigital():
    # Try common search URLs
    urls = [
        "https://cgdigital.com.np/search?q=macbook",
        "https://cgdigital.com.np/catalogsearch/result/?q=macbook",
        "https://cgdigital.com.np/?s=macbook",
        "https://cgdigital.com.np/search/macbook"
    ]
    ...
    for url in urls:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'macbook' in response.text.lower() or 'apple' in response.text.lower():
                    print("Found relevant text in HTML!")
                    with open("cgdigital_debug.html", "w", encoding="utf-8") as f:
                        f.write(response.text)
                    print("Saved cgdigital_debug.html")
                    found = True
                    break
    ...
    if not found:
        print("\nCould not find a valid search page with 'macbook' text.")
        return
